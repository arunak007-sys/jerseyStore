...
export default function MyStore() {
  ...
  const { likeProducts, setLikeProducts, cartProducts, setCartProducts, myJersey, prodDisp, setProdDdisp, setSearchQuery,signIn, setSignIn,
    cartQuantity} = useContext(myContext)
  ...
  console.log("Second", cartQuantity)
  // Search 
    ...
    <div className="amain">
          ...
          <Container fluid>
            ...
            <Navbar.Collapse id="navbarScroll">
              ...
              <Form className="d-flex">
                <Form.Control type="search" onChange={handleSearchInputChange} placeholder="Search" className="me-2" style={{ width: 400, marginLeft: 80 }} aria-label="Search" />
                <Button variant="outline-info" onClick={Search}>Search</Button>
              </Form>

              <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: "100px", marginLeft: "0" }} navbarScroll>
      ...
      <div className="aacenter">
        ...
        <div className="amain-card">
          {
            filteredUsers?filteredUsers.map((data, index) => (
              
              <div class="card" style={{ height: '600px', width: '400px', marginBottom: '40px', border: '10px bold black' }}>
                {/* <Link><CiHeart  onClick={() => clicksForWish(data,index)} style={{ height: '35px', width: '35px', marginLeft: '360px',color:colors[index]}} > */}
                {/* {
                          likeProducts.includes(data)? setCol : data
                        } */}
                {/* </CiHeart></Link> */}
