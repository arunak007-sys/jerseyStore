...
export default function InterMiami() {
    ...
    const { interMiami,setInterMiami,likeProducts, setLikeProducts, cartProducts, setCartProducts, myJersey, prodDisp, setProdDdisp, setSearchQuery, setMyJersey, signIn, setSignIn,
    ...
    useEffect(() => {
        handleShopByInterMiami()
      }, [])
    
      function handleShopByInterMiami() {
    
        setInterMiami(myJersey.filter(data => data.specialCategory == "InterMiami"))
      }
...
<Nav.Link style={{ fontWeight: 'bold' }} >Call Us : +91-9746726000</Nav.Link>
            ...
            <div className="centerc5">
                <div className="imagec">
                    <img src="https://dms.mydukaan.io/original/webp/media/314c437c-2b87-4935-89d9-07635b6712f5.blob" alt="" />
                </div>
                <div className="imageTitlec"><p>Shop By Teams<h5 >({interMiami.length} items)</h5></p></div>
                <div><p style={{ color: 'grey', letterSpacing: 1 }}><Link to={'/'} style={{ textDecoration: 'none', color: 'black' }}>Home</Link> &nbsp;/ &nbsp;Inter Miami</p></div>
