...
export default function ShopByTeams() {
    ...
    const { shopByteams, setShopByTeams,searchItem,setItemSearch,searchQuery,SetSearchItem, setLikeProducts, cartProducts, setCartProducts, myJersey, prodDisp, setProdDdisp, setSearchQuery, setMyJersey, signIn, setSignIn,
         likeProducts } = useContext(myContext)

    useEffect(() => {
        handleShopByteams()
    }, [])

    function handleShopByteams() {

        setShopByTeams(myJersey.filter(data => data.category == "Shop By Teams"))
    }
        ...
        <div className="mainc">
            ...
            <div className="centerc5">
                <div className="imagec">
                    <img src="https://dms.mydukaan.io/original/webp/media/50b3f49f-6d30-47a3-9968-076d6018dc48.blob" alt="" />
                </div>
                <div className="imageTitlec"><p>Shop By Teams<h5 >({shopByteams.length} items)</h5></p></div>
                <div><p style={{ color: 'grey', letterSpacing: 1 }}><Link to={'/'} style={{ textDecoration: 'none', color: 'black' }}>Home</Link> &nbsp;/ &nbsp;Shop By Teams</p></div>
