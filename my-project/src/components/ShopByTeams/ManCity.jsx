...
export default function ManCity() {
    ...
    const { likeProducts, setLikeProducts, cartProducts, setCartProducts, myJersey, prodDisp, setProdDdisp, setSearchQuery,  signIn, setSignIn,
     manchesterCity,setManchesterCity,searchItem,setItemSearch,searchQuery,SetSearchItem } = useContext(myContext)
    ...
    useEffect(() => {
        handleShopByManchesterCity()
      }, [])
    
      function handleShopByManchesterCity() {
    
        setManchesterCity(myJersey.filter(data => data.specialCategory == "ManChesterCity"))
      }
...
<Nav.Link style={{ fontWeight: 'bold' }} >Call Us : +91-9746726000</Nav.Link>
            ...
            <div className="centerc5">
                <div className="imagec">
                    <img src="https://dms.mydukaan.io/original/webp/media/bf69bef7-4b78-435a-b301-ff39ec94feed.blob" alt="" />
                </div>
                <div className="imageTitlec"><p>Shop By Teams<h5 >({manchesterCity.length} items)</h5></p></div>
