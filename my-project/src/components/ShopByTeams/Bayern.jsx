...
export default function Bayern() {
    ...
    const {  likeProducts, setLikeProducts, cartProducts, setCartProducts, myJersey, prodDisp, setProdDdisp, setSearchQuery,  signIn, setSignIn,
      bayern,setBayern,searchItem,setItemSearch,searchQuery,SetSearchItem } = useContext(myContext)
    ...
    useEffect(() => {
      ...
      function handleShopByBayern() {
    
        setBayern(myJersey.filter(data => data.specialCategory == "Bayern"))
      }
...
<Nav.Link style={{ fontWeight: 'bold' }} >Call Us : +91-9746726000</Nav.Link>
            ...
            <div className="centerc5">
                ...
                <div className="imageTitlec"><p>Shop By Teams<h5 >({bayern.length} items)</h5></p></div>
